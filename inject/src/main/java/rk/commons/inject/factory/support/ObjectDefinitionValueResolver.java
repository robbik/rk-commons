...
public class ObjectDefinitionValueResolver {
	...
	public ObjectDefinitionValueResolver(ObjectFactory beanFactory) {
	...
	public Object resolveValueIfNecessary(Object value) {
		...
		} else if (value instanceof FactoryObject) {
			c = resolveValueIfNecessary(((FactoryObject<?>) value).getObject());
		} else {
			c = value;
		}
