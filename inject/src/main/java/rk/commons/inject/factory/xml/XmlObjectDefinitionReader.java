...
public class XmlObjectDefinitionReader implements ErrorHandler, EntityResolver {
	...
	public XmlObjectDefinitionReader(URL docURL, NamespaceSchemaResolver resolver) {
		this.docURL = docURL;
